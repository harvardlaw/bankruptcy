(function ($) {
    ...
    $("#vehicle_year_dropdown").on("change", function() {
        ...
        // change icon color to indicate completed field
        $("#icon_year").attr('class', 'material-icons left torchred');
        ...
        $("#vehicle_condition_dropdown").val("").prop('disabled', true);
    ...
    $("#vehicle_make_dropdown").on("change", function() {
        ...
        // change icon color to indicate completed field
        $("#icon_make").attr('class', 'material-icons left torchred');
    ...
    $("#vehicle_model_dropdown").on("change", function() {
        ...
        // change icon color to indicate completed field
        $("#icon_model").attr('class', 'material-icons left torchred');
    ...
    $("#vehicle_trim_dropdown").on("change", function() {
        ...
        // change icon color to indicate completed field
        $("#icon_trim").attr('class', 'material-icons left torchred');
    ...
    $("#vehicle_color_dropdown").on("change", function() {
        ...
        // change icon color to indicate completed field
        $("#icon_color").attr('class', 'material-icons left torchred');
        ...
        // enable next form
        $("#vehicle_condition_dropdown").val("").prop('disabled', false);
    });

    // on change of vehicle_condition_form
    $("#vehicle_condition_dropdown").on("change", function() {

        // assign vehicle_condition to variable
        vehicle_condition = $("[name=vehicle_condition_input]:checked").val();

        // change icon color to indicate completed field
        $("#icon_condition").attr('class', 'material-icons left torchred');
    ...
    // on click of vehicle_mileage_input
    $("#vehicle_mileage_input").on("click", function() {

        // change icon color to indicate completed field
        $("#icon_mileage").attr('class', 'material-icons torchred');
    });

    // on change of vehicle_mileage_input
    ...
    // on click of vehicle_zipcode_input
    $("#vehicle_zipcode_input").on("click", function() {
        // change icon color to indicate completed field
        $("#icon_zipcode").attr('class', 'material-icons torchred');
    });

    // on change of vehicle_zipcode_input
    $("#vehicle_zipcode_input").on("change", function() {
        ...
        // otherwise
            ...
            "&color=" + vehicle_color + "&fmt=json&api_key=2skrh7ku3dkgzen67zwxcszy", function (returned_data){
                ...
                // display vehicle_tmv
                $("#vehicle_tmv_output").val(vehicle_tmv);
            });
        }
    });
}(jQuery));